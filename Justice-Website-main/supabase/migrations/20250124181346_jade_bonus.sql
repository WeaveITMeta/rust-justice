...
DO $$ 
BEGIN
  DROP POLICY IF EXISTS "Program tests are viewable by all authenticated users" ON public.program_tests;
  DROP POLICY IF EXISTS "Administrators can manage program tests" ON public.program_tests;
  DROP POLICY IF EXISTS "Test questions are viewable by all authenticated users" ON public.test_questions;
  DROP POLICY IF EXISTS "Administrators can manage test questions" ON public.test_questions;
  ...
  DROP POLICY IF EXISTS "Administrators can view all test results" ON public.user_test_results;
END $$;
